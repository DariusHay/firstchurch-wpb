  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Church of God in Christ, Inc."
      />
      ...
      >
        {/* Opening statement */}
        <p className="text-2xl md:text-3xl font-bold mb-6 text-fcPurple">
        ...
        <div className="space-y-4 text-lg md:text-xl text-slate-800">
          <p>
            <span className="font-semibold text-fcPurple">W</span>e believe
          ...
          <p>
            <span className="font-semibold text-fcPurple">W</span>e believe in
